...
const features = [
  {
    name: 'Bonds',
    summary: 'Earn interest from a range of yield generators.',
    featuredName:'Nous Bond',
    description:
...
function Feature({ feature, isActive, className, ...props }) {
  return (
    ...
    >
      ...
      <p className="mt-2 mb-4 font-display text-2xl text-slate-900">
        {feature.summary}
      </p>
      <p className="mt-8 mr-2 inline text-md font-semibold text-slate-900">{feature.featuredName}</p>
      <span className="inline-flex items-center mt-4 px-2.5 py-0.5 rounded-md text-sm font-medium bg-blue-100 text-blue-600">
        
        <h1 className="mx-2">Featured</h1>
      </span>
      
      <p className="mt-2 block text-sm text-slate-600">{feature.description}</p>
    </div>
  )
}
    ...
    <Tab.Group as="div" className="hidden lg:mt-20 lg:block">
      {({ selectedIndex }) => (
        <>
          ...
          <Tab.Panels className="relative mt-20 overflow-hidden rounded-2xl bg-white border-transparent border ">
